...
export type { Card, PathCard, ActionCard, Role, PathShape, ActionType, CellContent, GoalCardState } from "./state";
export {
  createInitialState,
  BOARD_COLS,
  BOARD_ROWS,
...
export const saboteurDefinition: GameDefinition<SaboteurState, SaboteurAction> = {
  ...
  metadata: {
    description: "Dwarves dig for gold while saboteurs try to thwart them. A card game of tunneling and trickery.",
    minPlayers: 3,
    maxPlayers: 10,
