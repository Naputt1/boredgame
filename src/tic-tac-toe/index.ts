...
export { createInitialState, computeWinner } from './state'
export { ticTacToeReducer, replayActions } from './reducer'
...
> = {
  ...
  metadata: {
    description:
      'Classic 3×3 Tic-Tac-Toe. Two players alternate placing X and O. Three in a row wins.',
    minPlayers: 1,
    maxPlayers: 2,
