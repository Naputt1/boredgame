...
export { createInitialState, isInsideBoard } from './state'
export { demoGameReducer, replayActions } from './reducer'
export type { PlayerId, BoardSize, BoardPosition, Player, Token } from './state'
...
export const demoGameDefinition: GameDefinition<DemoGameState, DemoGameAction> =
  {
    ...
    metadata: {
      description:
        'A multiplayer board game on a shared 8×8 grid. Place your token and move around the board.',
      minPlayers: 1,
      maxPlayers: 5,
    ...
    validateAction: validateAuthoritativeAction,
  }
